...
with tf.Session(config=config) as sess:
    ...
    # restore variables
    imported_meta = tf.train.import_meta_graph(ckpt_dir + '21/model.ckpt-500.meta')
    # imported_meta.restore(sess, tf.train.latest_checkpoint(ckpt_dir + '21/'))
    imported_meta.restore(sess, ckpt_dir + '21/model.ckpt-500')
